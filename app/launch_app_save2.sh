...
version_geonature_installee=$(get_version_installed /$script_home_dir/sysfiles geonature)
version_usershub_depot=$USERSHUB_VERSION
version_usershub_installee=$(get_version_installed /$script_home_dir/sysfiles usershub)
version_taxhub_depot=$TAXHUB_VERSION
version_taxhub_installee=$(get_version_installed /$script_home_dir/sysfiles taxhub)
